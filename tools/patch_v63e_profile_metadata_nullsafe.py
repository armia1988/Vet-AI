...
runpy.run_path('tools/patch_v65d_restore_customer_read_helper.py', run_name='__main__')
...
runpy.run_path('tools/patch_v69a_customer_sound_appbar_compat.py', run_name='__main__')
